...
2. **SomeRanDev - Tut #2: Creating an NPC!**: Tạo sự kiện, dùng lệnh _Show Text_ cho nhân vật nói chuyện. ^0156e2
	- **Did:** Tạo một NPC bằng event, tạo tương tác dialogue đơn giản![[content/assets/PixPin_2026-08-08_16-07-50.webp]]
...
4. **SomeRanDev - Tut #4: Making NPCs Move!**: Học cách cho nhân vật tự động di chuyển quanh map (Random, Approach, Custom).
	- **Did:** Thiết lập di chuyển tự động (Autonomous Movement) cho NPC theo các chế độ tự động (random, Approach), chế độ tùy chỉnh cũng tương tự nhưng do không gian map hẹp nên chưa đụng tới. ![[content/assets/PixPin_2026-08-08_18-15-33.webp]]
